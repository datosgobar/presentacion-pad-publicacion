...
<meta name="csrf-token" content="BKzdQ7k00Lu5Wjw3azhda1sVVeAWFxOnjYl8Vd3jkrMAkPdbq74iQXzpLlms29JMRlbxyabFoLnRs2wSOSVU2A==" />
  ...
  <link rel="stylesheet" media="all" href="//assets0.uvcdn.com/pkg/clients/site2-ed0993a2ea9f69b54c5b888a5a3182be.css" />
...
<fieldset class="uvSignin uvSignin-prestine uvSignin-default uvFieldset" data-options="{&quot;subclass&quot;:&quot;StandaloneSignin&quot;}"  aria-live="polite" aria-relevant="additions removals" data-subclass='StandaloneSignin'>
  ...
  <div class="uvSigninMode" style="display:none">prestine</div>
      <div class="uvField uvField-display_name uvField-first">
        <label class="uvFieldInner" for="display_name_6817">
          <span class="uvFieldPlaceholder">Your name</span>
          <input class="uvFieldText" type="text" name="display_name" id="display_name_6817" title="Your name" />
        </label>
      </div>
      <div class="uvField uvField-email uvField-first">
        <label class="uvFieldInner" for="email_6817">
          <span class="uvFieldPlaceholder">Your email address</span>
          <input class="uvFieldText" type="email" name="email" id="email_6817" value="" title="Your email address">
        </label>
      ...
      <div class="uvField uvField-authentication">
        ...
        <img class="password" alt="Password icon" src="//assets0.uvcdn.com/pkg/shared/favicons/password-d904f06a67a7b29d489489d3a35f548b.png" />
        <div class="password">
          <label class="uvFieldInner" for="password_6817">
            <span class="uvFieldPlaceholder">UserVoice password</span>
            <input class="uvFieldPassword" type="password" name="password" id="password_6817" title="UserVoice password" />
          </label>
...
<!-- site2 index cached -->
  ...
  <script src="//assets0.uvcdn.com/pkg/clients/site2-bac44086d37a5285b1cdbf1e6c924c9d.js"></script>
  <script type="text/javascript">
